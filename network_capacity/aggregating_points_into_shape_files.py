...
distribution_polys = gp.GeoDataFrame.from_file('data/wmca_WPD/wmca_distribution-area.shp')
...
plt.savefig('plots/network_capacity/dist_agg_peak.png')
dist_df.to_csv('outputs/network_capacity/dist_peak_agg.csv', index=False)
...
plt.savefig('plots/network_capacity/primary_agg_peak.png')
primary_df.to_csv('outputs/network_capacity/primary_peak_agg.csv', index=False)

print('GSP Poly....')
GSP_polys = gp.GeoDataFrame.from_file('data/wmca_WPD/wmca_GSP.shp')
...
plt.savefig('plots/network_capacity/GSP_agg_plt.png')
GSP_df.to_csv('outputs/network_capacity/GSP_peak_agg.csv', index=False)


print('BSP Poly....')
BSP_polys = gp.GeoDataFrame.from_file('data/wmca_WPD/wmca_BSP.shp')
...
plt.savefig('plots/network_capacity/BSP_agg_plt.png')
BSP_df.to_csv('outputs/network_capacity/BSP_peak_agg.csv', index=False)


print('WMCA Poly....')
WMCA_polys = gp.GeoDataFrame.from_file('data/wmca_WPD/wmca.shp')
print('To CRS....')
...
plt.savefig('plots/network_capacity/WMCA_agg_plt.png')
WMCA_df.to_csv('outputs/network_capacity/WMCA_peak_agg.csv', index=False)



properties.to_csv('outputs/network_capacity/properties_with_polygons.csv', index=False)
